            ...
            <a
              ...
              href={
                locale === LanguagesSupported[1]
                  ? 'https://docs.kozmo.ai/v/zh-hans/guides/knowledge-base/integrate-knowledge-within-application'
                  : 'https://docs.kozmo.ai/guides/knowledge-base/integrate-knowledge-within-application'
              }
...
const DatasetDetailLayout: FC<IAppDetailLayoutProps> = (props) => {
  ...
  useEffect(() => {
    if (datasetRes)
      document.title = `${datasetRes.name || 'Dataset'} - Kozmo`
  }, [datasetRes])
  ...
  return (
    <div className='grow flex overflow-hidden'>
      {!hideSideBar && <AppSideBar
        ...
        icon={datasetRes?.icon || 'https://static.kozmo.ai/images/dataset-default-icon.png'}
