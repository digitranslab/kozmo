...
<div>
  ...
  Kozmo Service API 使用 `API-Key` 进行鉴权。
    ...
    <Properties>
      ...
      <Property name='doc_metadata' type='object' key='doc_metadata'>
        ...
        文档元数据（如提供文档类型则必填）。字段因文档类型而异：
          ...
          请查看 [api/services/dataset_service.py](https://github.com/digitranslab/kozmo/blob/main/api/services/dataset_service.py#L475) 了解各文档类型所需字段的详细信息。
