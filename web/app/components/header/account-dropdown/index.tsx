...
export default function AppSelector({ isMobile }: IAppSelector) {
  ...
  const { userProfile, digitranslabVersionInfo } = useAppContext()
  ...
  return (
    <div className="">
                  ...
                  <div className="px-1 py-1">
                    ...
                    {canEmailSupport && <Menu.Item>
                      {({ active }) => <a
                        ...
                        href={mailToSupport(userProfile.email, plan.type, digitranslabVersionInfo.current_version)}
                    ...
                    <Menu.Item>
                      {({ active }) => <Link
                        ...
                        href='https://github.com/digitranslab/kozmo/discussions/categories/feedbacks'
                        target='_blank' rel='noopener noreferrer'>
                    ...
                    <Menu.Item>
                      {({ active }) => <Link
                        ...
                        href={
                          locale !== LanguagesSupported[1] ? 'https://docs.kozmo.ai/' : `https://docs.kozmo.ai/v/${locale.toLowerCase()}/`
                        }
                        target='_blank' rel='noopener noreferrer'>
                        ...
                        <Menu.Item>
                          {({ active }) => <div className={classNames(itemClassName, 'justify-between',
                            ...
                            <div className='flex items-center'>
                              <div className='mr-2 system-xs-regular text-text-tertiary'>{digitranslabVersionInfo.current_version}</div>
                              <Indicator color={digitranslabVersionInfo.current_version === digitranslabVersionInfo.latest_version ? 'green' : 'orange'} />
                            </div>
                          </div>}
                        </Menu.Item>
                      )
      ...
      {
        aboutVisible && <AccountAbout onCancel={() => setAboutVisible(false)} digitranslabVersionInfo={digitranslabVersionInfo} />
      }
    </div >
  )
}
