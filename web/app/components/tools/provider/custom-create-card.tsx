...
const Contribute = ({ onRefreshData }: Props) => {
  ...
  const linkUrl = useMemo(() => {
    if (language.startsWith('zh_'))
      return 'https://docs.kozmo.ai/zh-hans/guides/tools#ru-he-chuang-jian-zi-ding-yi-gong-ju'
    return 'https://docs.kozmo.ai/guides/tools#how-to-create-custom-tools'
  }, [language])
