...
<style>
  #kozmo-chatbot-bubble-button {
    background-color: ${primaryColor} !important;
  }
  #kozmo-chatbot-bubble-window {
...
const Embedded = ({ siteInfo, isShow, onClose, appBaseUrl, accessToken, className }: Props) => {
  ...
  const isTestEnv = digitranslabVersionInfo.current_env === 'TESTING' || digitranslabVersionInfo.current_env === 'DEVELOPMENT'
  const onClickCopy = () => {
  ...
  const navigateToChromeUrl = () => {
    window.open('https://chrome.google.com/webstore/detail/kozmo-chatbot/ceehdapohffmjmkdcifjofadiaoeggaf', '_blank')
  }
