const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Sau încercați versiunea cloud a Kozmo cu cotă gratuită',
  },
  overview: {
    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajută vizitatorii să înțeleagă datele pe care le colectează aplicația, consultați <privacyPolicyLink>Politica de confidențialitate</privacyPolicyLink> a Kozmo.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalați extensia Chrome Kozmo Chatbot',
        copied: 'Copiat',
        copy: 'Copiați',
      },
      qrcode: {
