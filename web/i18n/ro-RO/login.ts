const translation = {
  ...
  welcome: 'Bine ai venit la Kozmo, te rugăm să te autentifici pentru a continua.',
  ...
  license: {
    tip: 'Înainte de a începe Kozmo Community Edition, citește',
  ...
  or: 'SAU',
  resetPasswordDesc: 'Tastați e-mailul pe care l-ați folosit pentru a vă înscrie pe Kozmo și vă vom trimite un e-mail de resetare a parolei.',
  changePasswordBtn: 'Setați o parolă',
  licenseLostTip: 'Nu s-a reușit conectarea serverului de licențe Kozmo. Contactați administratorul pentru a continua să utilizați Kozmo.',
  licenseInactive: 'Licență inactivă',
  licenseInactiveTip: 'Licența Kozmo Enterprise pentru spațiul de lucru este inactivă. Contactați administratorul pentru a continua să utilizați Kozmo.',
  licenseExpired: 'Licență expirată',
  licenseLost: 'Licență pierdută',
  licenseExpiredTip: 'Licența Kozmo Enterprise pentru spațiul de lucru a expirat. Contactați administratorul pentru a continua să utilizați Kozmo.',
}
