const translation = {
  ...
  license: {
    tip: 'GitHubのオープンソースライセンスを確認してから、Kozmo Community Editionを開始してください。',
    link: 'オープンソースライセンス',
  },
  join: '参加する',
  ...
  licenseExpiredTip: 'ワークスペースの Kozmo Enterprise ライセンスの有効期限が切れています。Difyを引き続き使用するには、管理者に連絡してください。',
  licenseInactive: 'ライセンスが非アクティブです',
  licenseInactiveTip: 'ワークスペースの Kozmo Enterprise ライセンスが非アクティブです。Difyを引き続き使用するには、管理者に連絡してください。',
