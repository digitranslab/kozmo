const translation = {
  ...
  welcome: 'Kozmo\'ye hoş geldiniz, devam etmek için lütfen giriş yapın.',
  ...
  license: {
    tip: 'Kozmo Community Edition\'ı başlatmadan önce GitHub\'daki',
  ...
  resetPasswordDesc: 'Kozmo\'a kaydolmak için kullandığınız e-postayı yazın, size bir şifre sıfırlama e-postası gönderelim.',
  ...
  back: 'Geri',
  licenseExpiredTip: 'Çalışma alanınız için Kozmo Enterprise lisansının süresi doldu. Kozmo\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseLostTip: 'Kozmo lisans sunucusuna bağlanılamadı. Kozmo\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseInactiveTip: 'Çalışma alanınız için Kozmo Enterprise lisansı etkin değil. Kozmo\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
