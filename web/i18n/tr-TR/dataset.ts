const translation = {
  ...
  intro1: 'Bilgi, Kozmo uygulamasına ',
  ...
  externalAPIPanelDescription: 'Harici bilgi API\'si, Kozmo dışındaki bir bilgi bankasına bağlanmak ve bu bilgi bankasından bilgi almak için kullanılır.',
