const translation = {
  ...
  intro1: 'دانش می‌تواند در برنامه Kozmo ',
  ...
  externalAPIPanelDescription: 'API دانش خارجی برای اتصال به یک پایگاه دانش خارج از Kozmo و بازیابی دانش از آن پایگاه دانش استفاده می شود.',
