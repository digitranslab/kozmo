const translation = {
  ...
  intro1: 'La Connaissance peut être intégrée dans l\'application Kozmo',
  ...
  externalAPIPanelDescription: 'L’API de connaissances externe est utilisée pour se connecter à une base de connaissances en dehors de Kozmo et récupérer des connaissances de cette base de connaissances.',
