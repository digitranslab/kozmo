const translation = {
  ...
  account: {
    ...
    digiTranslabAccount: 'Compte Kozmo',
    digiTranslabAccountTip: 'Votre compte Kozmo et les données utilisateur associées.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation envoyée, et ils peuvent se connecter à Kozmo pour accéder aux données de votre équipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Le service d\'hébergement OpenAI fourni par Kozmo vous permet d\'utiliser des modèles tels que GPT-3.5. Avant que votre quota d\'essai ne soit épuisé, vous devez configurer d\'autres fournisseurs de modèles.',
  ...
  apiBasedExtension: {
    title: 'Les extensions API fournissent une gestion centralisée des API, simplifiant la configuration pour une utilisation facile à travers les applications de Kozmo.',
    link: 'Apprenez comment développer votre propre Extension API.',
    linkUrl: 'https://docs.kozmo.ai/fonctionnalites/extension/extension_basee_sur_api',
  ...
  about: {
    ...
    nowAvailable: 'Kozmo {{version}} est maintenant disponible.',
    latestAvailable: 'Kozmo {{version}} est la dernière version disponible.',
  },
  appMenus: {
