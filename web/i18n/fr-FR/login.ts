const translation = {
  ...
  welcome: 'Bienvenue sur Kozmo, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer Kozmo Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur Kozmo',
  invalid: 'Le lien a expiré',
  explore: 'Explorez Kozmo',
  ...
  resetPasswordDesc: 'Tapez l’adresse e-mail que vous avez utilisée pour vous inscrire sur Kozmo et nous vous enverrons un e-mail de réinitialisation de mot de passe.',
  usePassword: 'Utiliser le mot de passe',
  licenseInactiveTip: 'La licence Kozmo Enterprise de votre espace de travail est inactive. Veuillez contacter votre administrateur pour continuer à utiliser Kozmo.',
  licenseLostTip: 'Échec de la connexion au serveur de licences Kozmo. Veuillez contacter votre administrateur pour continuer à utiliser Kozmo.',
  licenseExpired: 'Licence expirée',
  licenseLost: 'Licence perdue',
  licenseExpiredTip: 'La licence Kozmo Enterprise de votre espace de travail a expiré. Veuillez contacter votre administrateur pour continuer à utiliser Kozmo.',
