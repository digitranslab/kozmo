const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Ou experimente a versão em nuvem do Kozmo com cota gratuita',
  },
  overview: {
    title: 'Visão Geral',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajuda os visitantes a entender os dados coletados pelo aplicativo, consulte a <privacyPolicyLink>Política de Privacidade</privacyPolicyLink> do Kozmo.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalar a Extensão do Chrome Kozmo Chatbot',
        copied: 'Copiado',
        copy: 'Copiar',
      },
      qrcode: {
      ...
      customize: {
        ...
        way1: {
          ...
          step1Operation: 'Cliente-Web-Kozmo',
