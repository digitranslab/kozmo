const translation = {
  ...
  stepOne: {
    ...
    website: {
      ...
      firecrawlDocLink: 'https://docs.kozmo.ai/guides/knowledge-base/sync-from-website',
  ...
  otherDataSource: {
    ...
    description: 'Atualmente, a base de conhecimento da Kozmo possui apenas fontes de dados limitadas. Contribuir com uma fonte de dados para a base de conhecimento Kozmo é uma maneira fantástica de ajudar a aumentar a flexibilidade e o poder da plataforma para todos os usuários. Nosso guia de contribuição facilita o início. Clique no link abaixo para saber mais.',
