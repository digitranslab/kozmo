const translation = {
  ...
  welcome: 'Bem-vindo ao Kozmo, faça login para continuar.',
  ...
  license: {
    tip: 'Antes de começar a usar a Edição Comunitária do Kozmo, leia a',
    link: 'Licença de código aberto do GitHub',
  },
  join: 'Participar',
  joinTipStart: 'Convidamos você a participar da',
  joinTipEnd: 'equipe no Kozmo',
  invalid: 'O link expirou',
  explore: 'Explorar o Kozmo',
  ...
  resetPasswordDesc: 'Digite o e-mail que você usou para se inscrever no Kozmo e enviaremos um e-mail de redefinição de senha.',
  sendVerificationCode: 'Enviar código de verificação',
  usePassword: 'Usar senha',
  licenseInactiveTip: 'A licença do Kozmo Enterprise para seu espaço de trabalho está inativa. Entre em contato com o administrador para continuar usando o Kozmo.',
  licenseLostTip: 'Falha ao conectar o servidor de licenças Kozmo. Entre em contato com o administrador para continuar usando o Kozmo.',
  licenseExpired: 'Licença expirada',
  licenseLost: 'Licença perdida',
  licenseInactive: 'Licença inativa',
  licenseExpiredTip: 'A licença do Kozmo Enterprise para seu espaço de trabalho expirou. Entre em contato com o administrador para continuar usando o Kozmo.',
}
