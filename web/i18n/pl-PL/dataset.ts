const translation = {
  ...
  intro1: 'Wiedzę można zintegrować z aplikacją Kozmo ',
  ...
  externalAPIPanelDescription: 'Interfejs API wiedzy zewnętrznej służy do łączenia się z bazą wiedzy poza Kozmo i pobierania wiedzy z tej bazy wiedzy.',
  chunkingMode: {
