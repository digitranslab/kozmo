const translation = {
  ...
  account: {
    ...
    digiTranslabAccount: 'Konto Kozmo',
    digiTranslabAccountTip: 'Twoje konto Kozmo i powiązane dane użytkownika.',
  ...
  members: {
    ...
    invitationSentTip:
      'Zaproszenie zostało wysłane, a oni mogą zalogować się do Kozmo, aby uzyskać dostęp do danych Twojego zespołu.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Usługa hostowania OpenAI dostarczana przez Kozmo pozwala korzystać z modeli takich jak GPT-3.5. Przed wyczerpaniem limitu próbnego należy skonfigurować inne dostawców modeli.',
  ...
  apiBasedExtension: {
    title:
      'Rozszerzenia oparte na interfejsie API zapewniają scentralizowane zarządzanie interfejsami API, upraszczając konfigurację dla łatwego użytkowania w aplikacjach Kozmo.',
  ...
  about: {
    ...
    nowAvailable: 'Kozmo {{version}} jest teraz dostępny.',
    latestAvailable: 'Kozmo {{version}} jest najnowszą dostępną wersją.',
  },
  appMenus: {
