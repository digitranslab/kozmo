const translation = {
  ...
  welcome: 'Witaj w Kozmo, zaloguj się, aby kontynuować.',
  email: 'Adres e-mail',
  ...
  license: {
    tip: 'Przed rozpoczęciem wersji społecznościowej Kozmo, przeczytaj GitHub',
    link: 'Licencję open-source',
  },
  join: 'Dołącz',
  joinTipStart: 'Zapraszam Cię do dołączenia do',
  joinTipEnd: 'zespołu na Kozmo',
  invalid: 'Link wygasł',
  explore: 'Odkryj Kozmo',
  ...
  resetPasswordDesc: 'Wpisz adres e-mail, którego użyłeś do rejestracji w Kozmo, a my wyślemy Ci wiadomość e-mail z prośbą o zresetowanie hasła.',
  or: 'LUB',
  ...
  licenseExpiredTip: 'Licencja Kozmo Enterprise dla Twojego obszaru roboczego wygasła. Skontaktuj się z administratorem, aby kontynuować korzystanie z Kozmo.',
  licenseLostTip: 'Nie udało się nawiązać połączenia z serwerem licencji Kozmo. Skontaktuj się z administratorem, aby kontynuować korzystanie z Kozmo.',
  licenseInactiveTip: 'Licencja Kozmo Enterprise dla Twojego obszaru roboczego jest nieaktywna. Skontaktuj się z administratorem, aby kontynuować korzystanie z Kozmo.',
}
