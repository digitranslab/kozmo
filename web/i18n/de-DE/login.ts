const translation = {
  ...
  welcome: 'Willkommen bei Kozmo, bitte melde dich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor du mit Kozmo Community Edition beginnst, lies die',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf Kozmo beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: 'Kozmo erkunden',
  ...
  resetPasswordDesc: 'Geben Sie die E-Mail-Adresse ein, mit der Sie sich bei Kozmo angemeldet haben, und wir senden Ihnen eine E-Mail zum Zurücksetzen des Passworts.',
  ...
  licenseLostTip: 'Fehler beim Verbinden des Kozmo-Lizenzservers. Wenden Sie sich an Ihren Administrator, um Kozmo weiterhin zu verwenden.',
  licenseInactive: 'Lizenz inaktiv',
  licenseInactiveTip: 'Die Kozmo Enterprise-Lizenz für Ihren Arbeitsbereich ist inaktiv. Wenden Sie sich an Ihren Administrator, um Kozmo weiterhin zu verwenden.',
  licenseExpiredTip: 'Die Kozmo Enterprise-Lizenz für Ihren Arbeitsbereich ist abgelaufen. Wenden Sie sich an Ihren Administrator, um Kozmo weiterhin zu verwenden.',
