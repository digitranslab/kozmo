const translation = {
  ...
  account: {
    ...
    digiTranslabAccount: 'Tài khoản Kozmo',
    digiTranslabAccountTip: 'Tài khoản Kozmo của bạn và dữ liệu người dùng liên quan.',
  ...
  members: {
    ...
    invitationSentTip: 'Lời mời đã được gửi, và họ có thể đăng nhập vào Kozmo để truy cập vào dữ liệu nhóm của bạn.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      onTrial: 'DÙNG THỬ',
      exhausted: 'HẾT QUOTA',
      desc: 'Dịch vụ lưu trữ OpenAI được cung cấp bởi Kozmo cho phép bạn sử dụng các mô hình như GPT-3.5. Trước khi hết lượng truy vấn dùng thử, bạn cần thiết lập các nhà cung cấp mô hình khác.',
  ...
  apiBasedExtension: {
    title: 'Các tiện ích API cung cấp quản lý API tập trung, giúp cấu hình dễ dàng sử dụng trên các ứng dụng của Kozmo.',
  ...
  about: {
    ...
    nowAvailable: 'Kozmo {{version}} hiện đã có sẵn.',
    latestAvailable: 'Kozmo {{version}} là phiên bản mới nhất hiện có.',
  },
  appMenus: {
    overview: 'Giám sát',
