const translation = {
  ...
  welcome: 'Benvenuto su Kozmo, per favore accedi per continuare.',
  ...
  license: {
    tip: 'Prima di avviare Kozmo Community Edition, leggi su GitHub',
    link: 'Licenza open-source',
  },
  join: 'Unisciti',
  joinTipStart: 'Invitato a unirti al',
  joinTipEnd: 'team su Kozmo',
  invalid: 'Il link è scaduto',
  explore: 'Esplora Kozmo',
  ...
  resetPasswordDesc: 'Digita l\'e-mail che hai utilizzato per registrarti su Kozmo e ti invieremo un\'e-mail per reimpostare la password.',
  ...
  licenseLostTip: 'Impossibile connettersi al server licenze Kozmo. Contatta il tuo amministratore per continuare a utilizzare Kozmo.',
  licenseExpired: 'Licenza scaduta',
  licenseLost: 'Licenza persa',
  licenseExpiredTip: 'La licenza Kozmo Enterprise per la tua area di lavoro è scaduta. Contatta il tuo amministratore per continuare a utilizzare Kozmo.',
  licenseInactiveTip: 'La licenza Kozmo Enterprise per la tua area di lavoro è inattiva. Contatta il tuo amministratore per continuare a utilizzare Kozmo.',
