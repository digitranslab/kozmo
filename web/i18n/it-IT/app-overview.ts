const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'O prova la versione cloud di Kozmo con quota gratuita',
  },
  overview: {
    title: 'Panoramica',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip:
            'Aiuta i visitatori a capire i dati raccolti dall\'applicazione, vedi la <privacyPolicyLink>Privacy Policy</privacyPolicyLink> di Kozmo.',
      ...
      embedded: {
        ...
        chromePlugin: 'Installa l\'estensione Chrome di Kozmo Chatbot',
        copied: 'Copiato',
        copy: 'Copia',
      },
      qrcode: {
