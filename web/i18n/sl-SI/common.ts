const translation = {
  ...
  account: {
    ...
    digiTranslabAccount: 'Kozmo račun',
    digiTranslabAccountTip: 'Vaš Kozmo račun in povezani uporabniški podatki.',
    editName: 'Uredi ime',
  ...
  members: {
    ...
    invitationSentTip: 'Povabilo poslano, in po prijavi v Kozmo bodo imeli dostop do vaših podatkov ekipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Gostitvena storitev OpenAI, ki jo ponuja Kozmo, vam omogoča uporabo modelov, kot je GPT-3.5. Preden porabite kvoto za preizkus, morate nastaviti druge ponudnike modelov.',
  ...
  modelProvider: {
    ...
    apiBasedExtension: {
      title: 'Razširitve API omogočajo centralizirano upravljanje API, kar poenostavi konfiguracijo za enostavno uporabo v aplikacijah Kozmo.',
    ...
    about: {
      ...
      nowAvailable: 'Kozmo {{version}} je zdaj na voljo.',
      latestAvailable: 'Kozmo {{version}} je najnovejša različica na voljo.',
    },
    appMenus: {
      overview: 'Nadzor',
  ...
  apiBasedExtension: {
    ...
    title: 'Razširitve API zagotavljajo centralizirano upravljanje API, kar poenostavlja konfiguracijo za enostavno uporabo v aplikacijah Kozmo.',
    linkUrl: 'https://docs.kozmo.ai/features/extension/api_based_extension',
  ...
  about: {
    updateNow: 'Posodobi zdaj',
    nowAvailable: 'Kozmo {{version}} je zdaj na voljo.',
    latestAvailable: 'Kozmo {{version}} je najnovejša različica, ki je na voljo.',
    changeLog: 'Dnevnik sprememb',
  },
  appMenus: {
