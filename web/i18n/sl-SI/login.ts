const translation = {
  ...
  welcome: 'Dobrodošli v Kozmo, prosimo, prijavite se za nadaljevanje.',
  ...
  license: {
    tip: 'Preden začnete z Kozmo Community Edition, preberite GitHub',
    link: 'Licenco odprte kode',
  },
  join: 'Pridruži se',
  joinTipStart: 'Vabimo vas, da se pridružite',
  joinTipEnd: 'ekipi na Kozmo',
  invalid: 'Povezava je potekla',
  explore: 'Razišči Kozmo',
  ...
  licenseExpiredTip: 'Licenca za Kozmo Enterprise za vaš delovni prostor je potekla. Če želite še naprej uporabljati Kozmo, se obrnite na skrbnika.',
  usePassword: 'Uporaba gesla',
  sendVerificationCode: 'Pošlji kodo za preverjanje',
  resetPasswordDesc: 'Vnesite e-poštni naslov, ki ste ga uporabili za prijavo na Kozmo, in poslali vam bomo e-poštno sporočilo za ponastavitev gesla.',
  ...
  licenseLostTip: 'Povezava z licenčnim strežnikom Kozmo ni uspela. Če želite še naprej uporabljati Kozmo, se obrnite na skrbnika.',
  licenseInactiveTip: 'Licenca Kozmo Enterprise za vaš delovni prostor je neaktivna. Če želite še naprej uporabljati Kozmo, se obrnite na skrbnika.',
}
