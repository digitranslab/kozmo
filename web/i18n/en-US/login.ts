const translation = {
  ...
  welcome: '👋 Welcome to Kozmo, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Kozmo Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on Kozmo',
  invalid: 'The link has expired',
  explore: 'Explore Kozmo',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on Kozmo and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The Kozmo Enterprise license for your workspace has expired. Please contact your administrator to continue using Kozmo.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect Kozmo license server. Please contact your administrator to continue using Kozmo.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The Kozmo Enterprise license for your workspace is inactive. Please contact your administrator to continue using Kozmo.',
}
