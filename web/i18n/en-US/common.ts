const translation = {
  ...
  account: {
    ...
    digiTranslabAccount: 'Kozmo account',
    digiTranslabAccountTip: 'Your Kozmo account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Kozmo to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Kozmo allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Kozmo\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'Kozmo {{version}} is now available.',
    latestAvailable: 'Kozmo {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
