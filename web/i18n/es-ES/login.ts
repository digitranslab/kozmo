const translation = {
  ...
  welcome: 'Bienvenido a Kozmo, por favor inicia sesión para continuar.',
  ...
  license: {
    tip: 'Antes de comenzar con Kozmo Community Edition, lee la',
  ...
  resetPasswordDesc: 'Escriba el correo electrónico que utilizó para registrarse en Kozmo y le enviaremos un correo electrónico de restablecimiento de contraseña.',
  ...
  licenseInactiveTip: 'La licencia de Kozmo Enterprise para su espacio de trabajo está inactiva. Póngase en contacto con su administrador para seguir utilizando Kozmo.',
  licenseExpired: 'Licencia caducada',
  licenseLost: 'Licencia perdida',
  licenseExpiredTip: 'La licencia de Kozmo Enterprise para su espacio de trabajo ha caducado. Póngase en contacto con su administrador para seguir utilizando Kozmo.',
  licenseLostTip: 'No se pudo conectar el servidor de licencias de Dife. Póngase en contacto con su administrador para seguir utilizando Kozmo.',
}
