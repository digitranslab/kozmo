const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'O prueba la versión en la nube de Kozmo con una cotización gratuita',
  },
  overview: {
    title: 'Resumen',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ayuda a los visitantes a comprender los datos que recopila la aplicación, consulta la <privacyPolicyLink>Política de privacidad</privacyPolicyLink> de Kozmo.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalar la extensión de Chrome de Kozmo Chatbot',
        copied: 'Copiado',
        copy: 'Copiar',
      },
      qrcode: {
      ...
      customize: {
        ...
        way1: {
          ...
          step1Operation: 'Kozmo-WebClient',
