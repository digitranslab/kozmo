...
export const fetchDigiTranslabVersion: Fetcher<DigiTranslabVersionResponse, { url: string; params: Record<string, any> }> = ({ url, params }) => {
  return get<DigiTranslabVersionResponse>(url, { params })
}
