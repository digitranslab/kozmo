...
export declare class KozmoClient {
...
export declare class CompletionClient extends KozmoClient {
...
export declare class ChatClient extends KozmoClient {
  createChatMessage(
    inputs: any,
    query: string,
    user: User,
...
export declare class WorkflowClient extends KozmoClient {
