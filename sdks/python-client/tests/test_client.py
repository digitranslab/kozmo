...
API_BASE_URL = os.environ.get("API_BASE_URL", "https://api.kozmo.ai/v1")
...
class TestDifyClient(unittest.TestCase):
    ...
    def test_get_application_parameters(self):
        response = self.kozmo_client.get_application_parameters("test_user")
    ...
    def test_file_upload(self):
        ...
        with open(file_path, "rb") as file:
            ...
            response = self.kozmo_client.file_upload("test_user", files)
