...
class TencentCosStorage(BaseStorage):
    ...
    def __init__(self):
        ...
        self.bucket_name = kozmo_config.TENCENT_COS_BUCKET_NAME
        config = CosConfig(
            Region=kozmo_config.TENCENT_COS_REGION,
            SecretId=kozmo_config.TENCENT_COS_SECRET_ID,
            SecretKey=kozmo_config.TENCENT_COS_SECRET_KEY,
            Scheme=kozmo_config.TENCENT_COS_SCHEME,
        )
