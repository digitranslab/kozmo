...
class HuaweiObsStorage(BaseStorage):
    ...
    def __init__(self):
        ...
        self.bucket_name = kozmo_config.HUAWEI_OBS_BUCKET_NAME
        self.client = ObsClient(
            access_key_id=kozmo_config.HUAWEI_OBS_ACCESS_KEY,
            secret_access_key=kozmo_config.HUAWEI_OBS_SECRET_KEY,
            server=kozmo_config.HUAWEI_OBS_SERVER,
        )
