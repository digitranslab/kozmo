...
class VolcengineTosStorage(BaseStorage):
    ...
    def __init__(self):
        super().__init__()
        self.bucket_name = kozmo_config.VOLCENGINE_TOS_BUCKET_NAME
        self.client = tos.TosClientV2(
            ak=kozmo_config.VOLCENGINE_TOS_ACCESS_KEY,
            sk=kozmo_config.VOLCENGINE_TOS_SECRET_KEY,
            endpoint=kozmo_config.VOLCENGINE_TOS_ENDPOINT,
            region=kozmo_config.VOLCENGINE_TOS_REGION,
        )
