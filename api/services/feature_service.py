...
class FeatureService:
    ...
    def get_features(cls, tenant_id: str) -> FeatureModel:
        ...
        if kozmo_config.BILLING_ENABLED and tenant_id:
    ...
    def get_system_features(cls) -> SystemFeatureModel:
        ...
        if kozmo_config.ENTERPRISE_ENABLED:
    ...
    def _fulfill_system_params_from_env(cls, system_features: SystemFeatureModel):
        system_features.enable_email_code_login = kozmo_config.ENABLE_EMAIL_CODE_LOGIN
        system_features.enable_email_password_login = kozmo_config.ENABLE_EMAIL_PASSWORD_LOGIN
        system_features.enable_social_oauth_login = kozmo_config.ENABLE_SOCIAL_OAUTH_LOGIN
        system_features.is_allow_register = kozmo_config.ALLOW_REGISTER
        system_features.is_allow_create_workspace = kozmo_config.ALLOW_CREATE_WORKSPACE
        system_features.is_email_setup = kozmo_config.MAIL_TYPE is not None and kozmo_config.MAIL_TYPE != ""

    @classmethod
    def _fulfill_params_from_env(cls, features: FeatureModel):
        features.can_replace_logo = kozmo_config.CAN_REPLACE_LOGO
        features.model_load_balancing_enabled = kozmo_config.MODEL_LB_ENABLED
        features.dataset_operator_enabled = kozmo_config.DATASET_OPERATOR_ENABLED
