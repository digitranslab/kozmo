...
供应商需要继承 `__base.model_provider.ModelProvider` 基类，实现 `validate_provider_credentials` 供应商统一凭据校验方法即可，可参考 [AnthropicProvider](https://github.com/digitranslab/kozmo-runtime/blob/main/lib/model_providers/anthropic/anthropic.py)。
