...
class DatasetRetrieval:
    ...
    def retrieve(
        ...
        kozmo_documents = [item for item in all_documents if item.provider == "kozmo"]
        ...
        # deal with kozmo documents
        if kozmo_documents:
            records = RetrievalService.format_retrieval_documents(kozmo_documents)
            if records:
    ...
    def _on_retrieval_end(
        ...
        kozmo_documents = [document for document in documents if document.provider == "kozmo"]
        for document in kozmo_documents:
            if document.metadata is not None:
