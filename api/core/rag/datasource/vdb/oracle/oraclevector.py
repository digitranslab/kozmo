    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> OracleVector:
        ...
        return OracleVector(
            ...
            config=OracleVectorConfig(
                host=kozmo_config.ORACLE_HOST or "localhost",
                port=kozmo_config.ORACLE_PORT,
                user=kozmo_config.ORACLE_USER or "system",
                password=kozmo_config.ORACLE_PASSWORD or "oracle",
                database=kozmo_config.ORACLE_DATABASE or "orcl",
            ),
        )
