    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> PGVector:
        ...
        return PGVector(
            ...
            config=PGVectorConfig(
                host=kozmo_config.PGVECTOR_HOST or "localhost",
                port=kozmo_config.PGVECTOR_PORT,
                user=kozmo_config.PGVECTOR_USER or "postgres",
                password=kozmo_config.PGVECTOR_PASSWORD or "",
                database=kozmo_config.PGVECTOR_DATABASE or "postgres",
                min_connection=kozmo_config.PGVECTOR_MIN_CONNECTION,
                max_connection=kozmo_config.PGVECTOR_MAX_CONNECTION,
            ),
        )
