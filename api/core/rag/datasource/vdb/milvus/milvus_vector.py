...
class MilvusVectorFactory(AbstractVectorFactory):
    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> MilvusVector:
        ...
        return MilvusVector(
            ...
            config=MilvusConfig(
                uri=kozmo_config.MILVUS_URI or "",
                token=kozmo_config.MILVUS_TOKEN or "",
                user=kozmo_config.MILVUS_USER or "",
                password=kozmo_config.MILVUS_PASSWORD or "",
                database=kozmo_config.MILVUS_DATABASE or "",
                enable_hybrid_search=kozmo_config.MILVUS_ENABLE_HYBRID_SEARCH or False,
            ),
        )
