    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> TencentVector:
        ...
        return TencentVector(
            ...
            config=TencentConfig(
                url=kozmo_config.TENCENT_VECTOR_DB_URL or "",
                api_key=kozmo_config.TENCENT_VECTOR_DB_API_KEY,
                timeout=kozmo_config.TENCENT_VECTOR_DB_TIMEOUT,
                username=kozmo_config.TENCENT_VECTOR_DB_USERNAME,
                database=kozmo_config.TENCENT_VECTOR_DB_DATABASE,
                shard=kozmo_config.TENCENT_VECTOR_DB_SHARD,
                replicas=kozmo_config.TENCENT_VECTOR_DB_REPLICAS,
            ),
        )
