    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> MyScaleVector:
        ...
        return MyScaleVector(
            ...
            config=MyScaleConfig(
                host=kozmo_config.MYSCALE_HOST,
                port=kozmo_config.MYSCALE_PORT,
                user=kozmo_config.MYSCALE_USER,
                password=kozmo_config.MYSCALE_PASSWORD,
                database=kozmo_config.MYSCALE_DATABASE,
                fts_params=kozmo_config.MYSCALE_FTS_PARAMS,
            ),
        )
