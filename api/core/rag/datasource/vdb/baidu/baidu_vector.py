...
class BaiduVectorFactory(AbstractVectorFactory):
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> BaiduVector:
        ...
        return BaiduVector(
            ...
            config=BaiduConfig(
                endpoint=kozmo_config.BAIDU_VECTOR_DB_ENDPOINT or "",
                connection_timeout_in_mills=kozmo_config.BAIDU_VECTOR_DB_CONNECTION_TIMEOUT_MS,
                account=kozmo_config.BAIDU_VECTOR_DB_ACCOUNT or "",
                api_key=kozmo_config.BAIDU_VECTOR_DB_API_KEY or "",
                database=kozmo_config.BAIDU_VECTOR_DB_DATABASE or "",
                shard=kozmo_config.BAIDU_VECTOR_DB_SHARD,
                replicas=kozmo_config.BAIDU_VECTOR_DB_REPLICAS,
            ),
        )
