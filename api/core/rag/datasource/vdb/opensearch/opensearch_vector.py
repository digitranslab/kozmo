...
class OpenSearchVectorFactory(AbstractVectorFactory):
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> OpenSearchVector:
        ...
        open_search_config = OpenSearchConfig(
            host=kozmo_config.OPENSEARCH_HOST or "localhost",
            port=kozmo_config.OPENSEARCH_PORT,
            user=kozmo_config.OPENSEARCH_USER,
            password=kozmo_config.OPENSEARCH_PASSWORD,
            secure=kozmo_config.OPENSEARCH_SECURE,
        )
