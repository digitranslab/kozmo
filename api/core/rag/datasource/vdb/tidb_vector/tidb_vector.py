    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> TiDBVector:
        ...
        return TiDBVector(
            ...
            config=TiDBVectorConfig(
                host=kozmo_config.TIDB_VECTOR_HOST or "",
                port=kozmo_config.TIDB_VECTOR_PORT or 0,
                user=kozmo_config.TIDB_VECTOR_USER or "",
                password=kozmo_config.TIDB_VECTOR_PASSWORD or "",
                database=kozmo_config.TIDB_VECTOR_DATABASE or "",
                program_name=kozmo_config.APPLICATION_NAME,
            ),
        )
