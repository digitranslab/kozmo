    ...
    def init_vector(
        ...
        return OceanBaseVector(
            ...
            OceanBaseVectorConfig(
                host=kozmo_config.OCEANBASE_VECTOR_HOST or "",
                port=kozmo_config.OCEANBASE_VECTOR_PORT or 0,
                user=kozmo_config.OCEANBASE_VECTOR_USER or "",
                password=(kozmo_config.OCEANBASE_VECTOR_PASSWORD or ""),
                database=kozmo_config.OCEANBASE_VECTOR_DATABASE or "",
            ),
        )
