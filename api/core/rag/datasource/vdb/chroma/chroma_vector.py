...
class ChromaVectorFactory(AbstractVectorFactory):
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> BaseVector:
        ...
        return ChromaVector(
            ...
            config=ChromaConfig(
                host=kozmo_config.CHROMA_HOST or "",
                port=kozmo_config.CHROMA_PORT,
                tenant=kozmo_config.CHROMA_TENANT or chromadb.DEFAULT_TENANT,
                database=kozmo_config.CHROMA_DATABASE or chromadb.DEFAULT_DATABASE,
                auth_provider=kozmo_config.CHROMA_AUTH_PROVIDER,
                auth_credentials=kozmo_config.CHROMA_AUTH_CREDENTIALS,
            ),
        )
