    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> PGVectoRS:
        ...
        return PGVectoRS(
            ...
            config=PgvectoRSConfig(
                host=kozmo_config.PGVECTO_RS_HOST or "localhost",
                port=kozmo_config.PGVECTO_RS_PORT or 5432,
                user=kozmo_config.PGVECTO_RS_USER or "postgres",
                password=kozmo_config.PGVECTO_RS_PASSWORD or "",
                database=kozmo_config.PGVECTO_RS_DATABASE or "postgres",
            ),
            dim=dim,
        )
