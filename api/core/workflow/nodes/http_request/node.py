...
HTTP_REQUEST_DEFAULT_TIMEOUT = HttpRequestNodeTimeout(
    connect=kozmo_config.HTTP_REQUEST_MAX_CONNECT_TIMEOUT,
    read=kozmo_config.HTTP_REQUEST_MAX_READ_TIMEOUT,
    write=kozmo_config.HTTP_REQUEST_MAX_WRITE_TIMEOUT,
)
            ...
            "config": {
                ...
                "timeout": {
                    **HTTP_REQUEST_DEFAULT_TIMEOUT.model_dump(),
                    "max_connect_timeout": kozmo_config.HTTP_REQUEST_MAX_CONNECT_TIMEOUT,
                    "max_read_timeout": kozmo_config.HTTP_REQUEST_MAX_READ_TIMEOUT,
                    "max_write_timeout": kozmo_config.HTTP_REQUEST_MAX_WRITE_TIMEOUT,
                },
            },
            "retry_config": {
                "max_retries": kozmo_config.SSRF_DEFAULT_MAX_RETRIES,
