...
class HttpRequestNodeTimeout(BaseModel):
    connect: int = kozmo_config.HTTP_REQUEST_MAX_CONNECT_TIMEOUT
    read: int = kozmo_config.HTTP_REQUEST_MAX_READ_TIMEOUT
    write: int = kozmo_config.HTTP_REQUEST_MAX_WRITE_TIMEOUT
