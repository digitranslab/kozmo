        ...
        if "builtin" in filters:
            ...
            for provider in builtin_providers:
                ...
                if provider.identity is None:
                    continue
                if is_filtered(
                    include_set=cast(set[str], kozmo_config.POSITION_TOOL_INCLUDES_SET),
                    exclude_set=cast(set[str], kozmo_config.POSITION_TOOL_EXCLUDES_SET),
                    data=provider,
