...
class VersionApi(Resource):
    def get(self):
        ...
        check_update_url = kozmo_config.CHECK_UPDATE_URL

        result = {
            "version": kozmo_config.CURRENT_VERSION,
            "release_date": "",
            "release_notes": "",
            "can_auto_update": False,
            "features": {
                "can_replace_logo": kozmo_config.CAN_REPLACE_LOGO,
                "model_load_balancing_enabled": kozmo_config.MODEL_LB_ENABLED,
            },
        }
