...
def test_run():
    ...
    pool.add(["pe", "list_output"], ["kozmo-1", "kozmo-2"])
    ...
    def tt_generator(self):
        return NodeRunResult(
            ...
            inputs={"iterator_selector": "kozmo"},
            outputs={"output": "kozmo 123"},
        )
    ...
    with patch.object(TemplateTransformNode, "_run", new=tt_generator):
        ...
        for item in result:
            ...
            if isinstance(item, RunCompletedEvent):
                ...
                assert item.run_result.outputs == {"output": ["kozmo 123", "kozmo 123"]}
